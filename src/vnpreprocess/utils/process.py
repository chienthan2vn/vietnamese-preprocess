...
""" emoji """
c2e_path = os.path.join(resources.files("vnpreprocess"),'dictionary/character2emoji.xlsx')
...
e2w_path = os.path.join(resources.files("vnpreprocess"),'dictionary/emoji2word.xlsx')
...
""" abbreviation """
adn_path = os.path.join(resources.files("vnpreprocess"),'dictionary/abb_dict_normal.xlsx')
...
ads_path = os.path.join(resources.files("vnpreprocess"),'dictionary/abb_dict_special.xlsx')
...
def abbreviation_predict(t):
    ...
    test_path = os.path.join(resources.files("vnpreprocess"),'dictionary/test_duplicate_abb_data.xlsx')
